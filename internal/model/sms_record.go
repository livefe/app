...
// 短信类型常量
const (
	SMSTypeVerification SMSType = "verification" // 验证码短信
	SMSTypeNotification SMSType = "notification" // 通知短信
	SMSTypeMarketing    SMSType = "marketing"    // 营销短信
	SMSTypeOther        SMSType = "other"        // 其他类型短信
)
...
type SMSRecord struct {
	...
	Type          SMSType        `gorm:"size:20;comment:短信类型" json:"type"`
